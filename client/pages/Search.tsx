      ...
      <div className="h-full w-full bg-primary p-6">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold text-visible">
              Global Search & Commands
            </h1>
            <p className="text-lg text-secondary-visible max-w-2xl mx-auto">
            ...
            <div className="flex items-center justify-center space-x-4 mt-6">
              <Badge variant="outline" className="text-sm px-3 py-1 bg-secondary/70 border-border text-visible">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="glass-blur border-border/50">
              <CardHeader className="pb-3">
                <CardTitle className="text-lg flex items-center text-visible">
                  <Users className="h-5 w-5 mr-2 accent-green" />
                  People Search
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-secondary-visible text-sm mb-3">
                  Find team members, collaborators, and contacts across your
                  workspace.
                </p>
                <ul className="text-xs text-muted-visible space-y-1">
          ...
          <div className="text-center space-y-4 py-8">
            <h2 className="text-2xl font-semibold text-visible">Try it out!</h2>
            <p className="text-secondary-visible">
              Press{" "}
              <kbd className="px-2 py-1 bg-secondary rounded text-visible font-mono text-sm border border-border">
                Cmd+K
              </kbd>{" "}
            ...
            <div className="flex justify-center space-x-4 mt-6">
              ...
              <Button variant="outline" className="border-border text-visible hover:bg-accent">
